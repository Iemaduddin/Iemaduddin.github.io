export const translations = {
  en: {
    ...
    "work.experience1.period": "Sept 2025 - Sept 2026",
    "work.experience1.location": "Surabaya, East Java",
    "work.experience1.type": "Full-time",
    "work.experience1.description": [
      "Developed and maintained multiple web applications using Vanilla PHP, Laravel, and Next.js (TypeScript).",
      "Handled the end-to-end software development lifecycle, including requirements analysis, system and architecture design, implementation, testing, and maintenance.",
      "Developed new features and performed bug fixing, debugging, refactoring, and application/database performance optimization.",
      "Managed application deployment and server maintenance, including configuration, monitoring, troubleshooting, and ensuring production stability.",
      "Developed and integrated APIs, third-party services, and AI technologies into web applications to improve automation, functionality, and system efficiency.",
      "Developed systems for web scraping, collecting, processing, and displaying statistical data from various sources, including social media platforms such as Instagram, Facebook, YouTube, TikTok, and X, while implementing on-page and technical SEO with Google Search Console monitoring.",
      "Applied an AI-driven software development workflow throughout the system development process, integrating AI into requirements analysis, system design, development, testing, documentation, and continuous improvement.",
    ],
  ...
  id: {
    ...
    "work.experience1.description": [
      "Mengembangkan dan memelihara berbagai aplikasi web menggunakan Vanilla PHP, Laravel, dan Next.js (TypeScript).",
      "Menangani proses pengembangan aplikasi secara end-to-end, mulai dari analisis kebutuhan, perancangan sistem dan arsitektur, implementasi, testing, hingga maintenance.",
      "Mengembangkan fitur baru serta melakukan bug fixing, debugging, refactoring, dan optimasi performa aplikasi maupun database.",
      "Menangani deployment dan maintenance server, termasuk konfigurasi, monitoring, troubleshooting, dan memastikan stabilitas aplikasi di production.",
      "Mengembangkan dan mengintegrasikan API, layanan pihak ketiga, serta teknologi AI ke dalam website untuk meningkatkan otomatisasi, fungsionalitas, dan efisiensi sistem.",
      "Mengembangkan sistem untuk web scraping, mengambil, mengolah, dan menampilkan data statistik dari berbagai sumber, termasuk media sosial seperti Instagram, Facebook, YouTube, TikTok, dan X, serta menerapkan on-page dan technical SEO dengan monitoring melalui Google Search Console.",
      "Menerapkan sistem kerja berbasis AI dalam proses pengembangan software, dengan memanfaatkan AI pada tahap analisis, perancangan, pengembangan, testing, dokumentasi, dan pengembangan berkelanjutan.",
    ],
    "work.experience2.position": "Full Stack Developer",
    "work.experience2.company": "PT. Lasbon Technology Indonesia",
    "work.experience2.period": "Sept 2024 - Jan 2025",
